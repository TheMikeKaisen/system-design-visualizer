...
console.log("End");`,
  steps: [
    ...
    },
    {
      ...
      webAPIs: [
        { id: "cb1", type: "setTimeout", label: "setTimeout()", callback: "() => console.log('Timeout')", delay: "0ms", status: "running" }
      ],
      microtaskQueue: [],
      callbackQueue: [],
      eventLoop: { phase: "stack_busy", message: "Call Stack is executing code" }
    ...
    },
    {
      ...
      microtaskQueue: [],
      callbackQueue: [],
      eventLoop: { phase: "moving_callback", message: "Moving callback to Call Stack", activeTask: { id: "cb1", label: "Anonymous ()", callback: "", source: "setTimeout" } }
    },
    {
      currentLine: 4,
...
console.log("End");`,
  steps: [
    ...
    },
    {
      ...
      consoleOutput: ["Start"],
      callStack: [{ id: "global", name: "Global Execution Context", phase: "Execution Phase", variables: [], outerEnvironment: null }],
      webAPIs: [{ id: "cb1", type: "setTimeout", label: "setTimeout()", callback: "() => console.log('Timeout')", delay: "0ms", status: "running" }],
      microtaskQueue: [],
      callbackQueue: [],
      eventLoop: { phase: "stack_busy", message: "Call Stack is busy" }
    },
    ...
    },
    {
      ...
      microtaskQueue: [],
      callbackQueue: [{ id: "cb1", label: "Anonymous ()", callback: "console.log('Timeout')", source: "setTimeout" }],
      eventLoop: { phase: "moving_callback", message: "Moving Microtask to Stack", activeTask: { id: "mt1", label: "Promise.then()", callback: "", source: "Promise" } }
    },
    {
      currentLine: 8,
      ...
      consoleOutput: ["Start", "End"],
      callStack: [{ id: "mt1", name: "Promise Callback", phase: "Creation Phase", variables: [], outerEnvironment: "Global" }],
      webAPIs: [],
      microtaskQueue: [],
      callbackQueue: [{ id: "cb1", label: "Anonymous ()", callback: "console.log('Timeout')", source: "setTimeout" }],
      eventLoop: { phase: "stack_busy", message: "Call Stack is busy" }
    },
    {
      ...
      callStack: [{ id: "mt1", name: "Promise Callback", phase: "Execution Phase", variables: [], outerEnvironment: "Global" }],
      webAPIs: [],
      microtaskQueue: [],
      callbackQueue: [{ id: "cb1", label: "Anonymous ()", callback: "console.log('Timeout')", source: "setTimeout" }],
      eventLoop: { phase: "stack_busy", message: "Call Stack is busy" }
    ...
    },
    {
      ...
      microtaskQueue: [],
      callbackQueue: [],
      eventLoop: { phase: "moving_callback", message: "Moving callback to Stack", activeTask: { id: "cb1", label: "Anonymous ()", callback: "", source: "setTimeout" } }
    },
    {
      currentLine: 4,
      ...
      callStack: [{ id: "cb1", name: "Anonymous ()", phase: "Execution Phase", variables: [], outerEnvironment: "Global" }],
      webAPIs: [],
      microtaskQueue: [],
      callbackQueue: [],
      eventLoop: { phase: "stack_busy", message: "Call Stack is busy" }
...
console.log("End");`,
  steps: [
    ...
    },
    {
      ...
      consoleOutput: ["Start"],
      callStack: [{ id: "global", name: "Global Execution Context", phase: "Execution Phase", variables: [], outerEnvironment: null }],
      webAPIs: [{ id: "mt1", type: "fetch", label: "fetch('api.example.com/data')", callback: ".then(response => response.json())", status: "running" }],
      microtaskQueue: [],
      callbackQueue: [],
      eventLoop: { phase: "stack_busy", message: "Call Stack is busy" }
    },
    ...
    },
    {
      ...
      consoleOutput: ["Start", "End"],
      callStack: [],
      webAPIs: [{ id: "mt1", type: "fetch", label: "fetch('api.example.com/data')", callback: ".then(response => response.json())", status: "complete" }],
      microtaskQueue: [],
      callbackQueue: [],
      eventLoop: { phase: "idle", message: "Call Stack empty, waiting for async tasks..." }
    },
    ...
    },
    {
      ...
      consoleOutput: ["Start", "End"],
      callStack: [{ id: "mt1", name: "Anonymous (response)", phase: "Execution Phase", variables: [{ name: "response", value: "Response Object" }], outerEnvironment: "Global" }],
      webAPIs: [],
      microtaskQueue: [],
      callbackQueue: [],
      eventLoop: { phase: "stack_busy", message: "Call Stack is busy" }
    ...
    },
    {
      ...
      callStack: [{ id: "mt2", name: "Anonymous (data)", phase: "Execution Phase", variables: [{ name: "data", value: "{ user: 'Alice' }" }], outerEnvironment: "Global" }],
      webAPIs: [],
      microtaskQueue: [],
      callbackQueue: [],
      eventLoop: { phase: "stack_busy", message: "Call Stack is busy" }
...
console.log("End");`,
  steps: [
    ...
    },
    {
      ...
      callStack: [{ id: "mt1", name: "Anonymous ()", phase: "Execution Phase", variables: [], outerEnvironment: "Global" }],
      webAPIs: [],
      microtaskQueue: [],
      callbackQueue: [{ id: "cb1", label: "Anonymous ()", callback: "console.log('Timeout')", source: "setTimeout" }],
      eventLoop: { phase: "stack_busy", message: "Call Stack is busy" }
    ...
    },
    {
      ...
      callStack: [{ id: "mt2", name: "Anonymous ()", phase: "Execution Phase", variables: [], outerEnvironment: "Global" }],
      webAPIs: [],
      microtaskQueue: [],
      callbackQueue: [{ id: "cb1", label: "Anonymous ()", callback: "console.log('Timeout')", source: "setTimeout" }],
      eventLoop: { phase: "stack_busy", message: "Call Stack is busy" }
...
console.log("End");`,
  steps: [
    ...
    },
    {
      ...
      consoleOutput: ["Start"],
      callStack: [{ id: "global", name: "Global Execution Context", phase: "Execution Phase", variables: [], outerEnvironment: null }],
      webAPIs: [{ id: "cb1", type: "setTimeout", label: "setTimeout()", callback: "console.log('Timer 1')", delay: "1000ms", status: "running" }],
      microtaskQueue: [],
      callbackQueue: [],
      eventLoop: { phase: "stack_busy", message: "Call Stack is busy" }
    },
    {
      ...
      callStack: [{ id: "global", name: "Global Execution Context", phase: "Execution Phase", variables: [], outerEnvironment: null }],
      webAPIs: [
        { id: "cb1", type: "setTimeout", label: "setTimeout()", callback: "console.log('Timer 1')", delay: "1000ms", status: "running" },
        { id: "cb2", type: "setTimeout", label: "setTimeout()", callback: "console.log('Timer 2')", delay: "500ms", status: "running" }
      ],
      microtaskQueue: [],
      callbackQueue: [],
      eventLoop: { phase: "stack_busy", message: "Call Stack is busy" }
    },
    {
      ...
      webAPIs: [
        { id: "cb1", type: "setTimeout", label: "setTimeout()", callback: "console.log('Timer 1')", delay: "1000ms", status: "running" },
        { id: "cb2", type: "setTimeout", label: "setTimeout()", callback: "console.log('Timer 2')", delay: "500ms", status: "running" },
        { id: "cb3", type: "setTimeout", label: "setTimeout()", callback: "console.log('Timer 3')", delay: "0ms", status: "running" }
      ],
      microtaskQueue: [],
      callbackQueue: [],
      eventLoop: { phase: "stack_busy", message: "Call Stack is busy" }
    ...
    },
    {
      ...
      consoleOutput: ["Start", "End"],
      callStack: [{ id: "cb3", name: "Anonymous ()", phase: "Execution Phase", variables: [], outerEnvironment: "Global" }],
      webAPIs: [
        { id: "cb1", type: "setTimeout", label: "setTimeout()", callback: "console.log('Timer 1')", delay: "1000ms", status: "running" },
        { id: "cb2", type: "setTimeout", label: "setTimeout()", callback: "console.log('Timer 2')", delay: "500ms", status: "running" }
      ],
    ...
    },
    {
      ...
      consoleOutput: ["Start", "End", "Timer 3 (0ms)"],
      callStack: [{ id: "cb2", name: "Anonymous ()", phase: "Execution Phase", variables: [], outerEnvironment: "Global" }],
      webAPIs: [
        { id: "cb1", type: "setTimeout", label: "setTimeout()", callback: "console.log('Timer 1')", delay: "1000ms", status: "running" }
      ],
      microtaskQueue: [],
...
console.log("6");`,
  steps: [
    ...
    },
    {
      ...
      consoleOutput: ["1"],
      callStack: [{ id: "global", name: "Global Execution Context", phase: "Execution Phase", variables: [], outerEnvironment: null }],
      webAPIs: [{ id: "cb1", type: "setTimeout", label: "setTimeout()", callback: "() => console.log('2')", delay: "0ms", status: "running" }],
      microtaskQueue: [],
      callbackQueue: [],
      eventLoop: { phase: "stack_busy", message: "Call Stack is busy" }
    },
    {
      ...
      webAPIs: [],
      microtaskQueue: [],
      callbackQueue: [{ id: "cb1", label: "Anonymous ()", callback: "console.log('2')", source: "setTimeout" }],
      eventLoop: { phase: "stack_busy", message: "Call Stack is busy" }
    },
    {
      currentLine: 5,
    ...
    },
    {
      ...
      callbackQueue: [{ id: "cb1", label: "Anonymous ()", callback: "console.log('2')", source: "setTimeout 1" }],
      eventLoop: { phase: "moving_callback", message: "Moving Microtask 1 to Stack", activeTask: { id: "mt1", label: "Promise.then()", callback: "", source: "Promise 1" } }
    },
    {
      currentLine: 6,
    ...
    },
    {
      ...
      consoleOutput: ["1", "6", "3"],
      callStack: [{ id: "mt1", name: "Anonymous ()", phase: "Execution Phase", variables: [], outerEnvironment: "Global" }],
      webAPIs: [{ id: "cb2", type: "setTimeout", label: "setTimeout()", callback: "() => console.log('4')", delay: "0ms", status: "running" }],
      microtaskQueue: [
        { id: "mt2", label: "Promise.then()", callback: "() => console.log('5')", source: "Promise 2" }
      ],
      callbackQueue: [{ id: "cb1", label: "Anonymous ()", callback: "console.log('2')", source: "setTimeout 1" }],
    ...
    },
    {
      ...
      consoleOutput: ["1", "6", "3"],
      callStack: [{ id: "mt1", name: "Anonymous ()", phase: "Execution Phase", variables: [], outerEnvironment: "Global" }],
      webAPIs: [{ id: "cb2", type: "setTimeout", label: "setTimeout()", callback: "() => console.log('4')", delay: "0ms", status: "complete" }],
      microtaskQueue: [
        { id: "mt2", label: "Promise.then()", callback: "() => console.log('5')", source: "Promise 2" }
      ],
      callbackQueue: [{ id: "cb1", label: "Anonymous ()", callback: "console.log('2')", source: "setTimeout 1" }],
