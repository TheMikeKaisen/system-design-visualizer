...
export function MobileSimulationOverlay() {
  ...
  if (!visible || !isAutoAdvanceStep || !narrative) return null;
  ...
  return (
    <div className="sm:hidden fixed inset-0 z-50 flex flex-col justify-end pointer-events-none">
      ...
      >
        ...
        {/* Action button — Resume if mid-sim, Restart if at end */}
        {canResume ? (
          <button
            onClick={handleResume}
            className="w-full py-3.5 mt-2 rounded-xl bg-amber-500 text-amber-950 font-bold text-sm flex items-center justify-center gap-2"
          >
