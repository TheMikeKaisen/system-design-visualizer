...
import { UpdateQueuePanel } from "./UpdateQueuePanel";
...
export function UseStateBatchingLayout() {
  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col p-4 gap-4 overflow-hidden bg-zinc-950">
        ...
        {/* Bottom: Snapshot + Update Queue */}
        <div className="flex-1 flex gap-4 min-h-0 w-full">
          <div className="flex-1 min-w-0">
            <SnapshotPanel entries={step.snapshotValues} renderCount={step.renderCount} />
          </div>
          <div className="flex-1 min-w-0">
            <UpdateQueuePanel queue={step.updateQueue} resolvedValue={step.resolvedValue} />
          </div>
        </div>
