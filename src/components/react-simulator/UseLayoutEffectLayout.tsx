...
import { TimingComparisonPanel } from "./TimingComparisonPanel";
...
export function UseLayoutEffectLayout() {
  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col p-4 gap-4 overflow-hidden bg-zinc-950">
        ...
        {/* Bottom: Timing Comparison + Browser Viewport */}
        <div className="flex-1 flex gap-4 min-h-0 w-full">
          <div className="flex-1 min-w-0">
            <TimingComparisonPanel step={step} />
          </div>
          <div className="flex-1 min-w-0">
            <BrowserViewport step={step} />
          </div>
        </div>
